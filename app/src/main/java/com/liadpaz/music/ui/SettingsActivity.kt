    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            findPreference<Preference>(KEY_FOLDER)!!.also { folderPreference = it }.onPreferenceClickListener = Preference.OnPreferenceClickListener {
                startActivityForResult(Intent(Intent.ACTION_OPEN_DOCUMENT_TREE).addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION), CHOOSE_FOLDER_REQUEST_NUM)
                true
            }
        ...
        override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
            if (requestCode == CHOOSE_FOLDER_REQUEST_NUM) {
        ...
        companion object {
            private const val CHOOSE_FOLDER_REQUEST_NUM = 321
        }
    }
...
private const val TAG = "SettingsActivityTag"