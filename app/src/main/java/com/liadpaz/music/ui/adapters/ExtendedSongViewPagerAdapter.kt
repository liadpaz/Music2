...
class ExtendedSongViewPagerAdapter(private val fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {
    ...
    override fun createFragment(position: Int): Fragment =
        ExtendedSongFragment.newInstance(viewModel.queue[position])
}