...
import com.liadpaz.music.databinding.ItemAlbumArtBinding
...
/**
 * This class is a view holder for an album art item
 */
class AlbumArtViewHolder private constructor(private val binding: ItemAlbumArtBinding) : RecyclerView.ViewHolder(binding.root) {
	...
	companion object {
		fun create(viewGroup: ViewGroup) = AlbumArtViewHolder(ItemAlbumArtBinding.inflate(viewGroup.layoutInflater, viewGroup, false))
	}
}
